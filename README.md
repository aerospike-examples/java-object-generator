...
mvn clean package
mvn install:install-file -Dfile=target/java-object-generator-0.9.jar -DgroupId=com.aerospike -DartifactId=java-object-generator -Dversion=0.9 -Dpackaging=jar
```
